...
echo html_writer::start_div(
    'wc-group-actions',
    ['id' => 'wc-group-actions', 'style' => 'display:none']
);
...
echo html_writer::tag(
    'div',
    '',
    ['id' => 'wc-json-status', 'class' => 'wc-json-status wc-hidden']
);
echo html_writer::end_div();
